...
| **Airport Subscription Changes / Node Expired** | Nodes expire or airport updates subscription URL. | Run `python scripts/update_subscription.py --url "<SUB_URL>"`. | Auto-downloads, injects TV parameters, hot-reloads Mihomo, and auto-selects the fastest node. |
